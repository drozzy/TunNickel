# %% 
from tunnickel.model import LstmModel, Module, NeuralOdeModel, ResNeuralOdeModel, AugNeuralOdeModel
...
MODEL = AugNeuralOdeModel(num_features=76, num_classes=NUM_LABELS)
