# %% 
from tunnickel.model import LstmModel, Module, NeuralOdeModel, ResNeuralOdeModel, AugNeuralOdeModel, PlainNeuralOdeModel
...
MODEL = PlainNeuralOdeModel(num_features=76, num_classes=NUM_LABELS)
